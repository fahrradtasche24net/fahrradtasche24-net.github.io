...
python /home/kempo/git/tools/structured-data-bot/globetrotter-de-outdoorhosen.py -c "Fahrradtaschen und Fahrradrucksäcke" -gc -gp -gb -db $database -of $newdomain -di && 
